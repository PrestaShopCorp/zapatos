...
const baseTsTypeForBasePgType = (pgType, tsType, enums, context, config) => {
    ...
    switch (pgType) {
        ...
        case 'jsonb':
            return 'db.JSONValue';
        default:
            if (hasOwnProp.call(enums, tsType))
                return tsType;
            return null;
    }
};
const tsTypeForPgType = (pgType, tsType, enums, context, config) => {
